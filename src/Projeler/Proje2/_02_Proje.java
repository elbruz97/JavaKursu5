...
public class _02_Proje {
    public static void main(String[] args) {
        ...
        List<String> musteriler = new ArrayList<>(Arrays.asList("User1", "User2", "User3"));
        ...
        List<String> hesapNumaralari = new ArrayList<>(Arrays.asList("1234", "5678", "9999"));

        // Banka musterilerine ait banka hesaplarinda bulunan para miktarlarini tanimlayin...200, 1000, 5000
        List<Integer> paraMiktarlari = new ArrayList<>(Arrays.asList(200, 1000, 5000));
